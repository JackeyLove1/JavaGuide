...
FROM
  Student AS s1
WHERE
  s1.SId <> '01' -- Exclude the student "01"
  AND NOT EXISTS (
...
from
  Student as s
  left join SC as sc on sc.SId = s.SId
where
  sc.score < 60.0
group by
  sc.SId,
